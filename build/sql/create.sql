...
VALUES
    ...
    (6, 'Бытовая техника', 1),
    (7, 'Холодильники', 6),
    (8, 'Стиральные машины', 6),
    (9, 'Пылесосы', 6),
    (10, 'Игровые консоли', 1),
    (11, 'PlayStation', 10),
    (12, 'Xbox', 10),
    (13, 'Nintendo', 10),
...
--------------------Холодильники-7
    ('007749b5-434c-4be8-8c91-8db273ace100', 'Холодильник Samsung RL4362RBASL/WT', 125999, 'holodos1.jpg', 'Холодильник Samsung RL4362RBASL/WT позволит уберечь ваши продукты питания от порчи. В холодильнике имеются две камеры: холодильная и морозильная, которая располагается в нижней части. Камеры в INDESIT DS 4180 S B размораживаются двумя способами: холодильная - капельным, а морозильная - ручным. В случае, если прекратится подача электроэнергии, устройство еще в течение 18 часов будет способно сохранять холод. В компрессоре холодильника используется хладагент R600a (изобутан). Возможность перевешивания дверей позволит вам выбрать, в какую сторону будет открываться холодильник.', 4.95, 7),
    ('007749b5-434c-4be8-8c91-8db273ace101', 'Холодильник Toshiba GR-RB449WE-PMJ(06)', 64999, 'holodos2.png', 'Холодильник Toshiba GR-RB449WE-PMJ(06) позволит уберечь ваши продукты питания от порчи. В холодильнике имеются две камеры: холодильная и морозильная, которая располагается в нижней части. Камеры в INDESIT DS 4180 S B размораживаются двумя способами: холодильная - капельным, а морозильная - ручным. В случае, если прекратится подача электроэнергии, устройство еще в течение 18 часов будет способно сохранять холод. В компрессоре холодильника используется хладагент R600a (изобутан). Возможность перевешивания дверей позволит вам выбрать, в какую сторону будет открываться холодильник.', 4.91, 7),
--------------------Стиральные машины-8
    ('007749b5-434c-4be8-8c91-8db273ace102', 'Стиральная машина Weissgauff WM 4606', 22370, 'stiralka1.jpg', 'Белая стиральная машина с нагревательным элементом Hi-Tech с защитой от накипи, максимальной загрузкой барабана 6 кг и электронным контролем дисбаланса, который предотвращает шум и вибрацию во время стирки и отжима. Стиральная машина оснащена технологией SteamCure, которая обрабатывает белье паром до и после стирки, облегчает отстирывание пятен и разглаживает ткани после отжима. 15 автоматических программ стирки позволяют ухаживать за одеждой из разных тканей, от хлопка до шерсти, а также джинсовыми, спортивными вещами и пуховиками.', 4.99, 8),
    ('007749b5-434c-4be8-8c91-8db273ace103', 'Cтиральная машина Beko WSPE6H616A', 25898, 'stiralka2.png', 'Черная стиральная машина с нагревательным элементом Hi-Tech с защитой от накипи, максимальной загрузкой барабана 6 кг и электронным контролем дисбаланса, который предотвращает шум и вибрацию во время стирки и отжима. Стиральная машина оснащена технологией SteamCure, которая обрабатывает белье паром до и после стирки, облегчает отстирывание пятен и разглаживает ткани после отжима. 15 автоматических программ стирки позволяют ухаживать за одеждой из разных тканей, от хлопка до шерсти, а также джинсовыми, спортивными вещами и пуховиками.', 4.66, 8),

    ('007749b5-434c-4be8-8c91-8db273ace104', '', 14999, 'macbook.png', '', 4.95, 5),
    ('007749b5-434c-4be8-8c91-8db273ace105', '', 14999, 'macbook.png', '', 4.90, 5),
    ('007749b5-434c-4be8-8c91-8db273ace106', '', 14999, 'macbook.png', '', 4.95, 5),
    ('007749b5-434c-4be8-8c91-8db273ace107', '', 14999, 'macbook.png', '', 4.90, 5),
    ('007749b5-434c-4be8-8c91-8db273ace108', '', 14999, 'macbook.png', '', 4.95, 5),
    ('007749b5-434c-4be8-8c91-8db273ace109', '', 14999, 'macbook.png', '', 4.90, 5),
    ('007749b5-434c-4be8-8c91-8db273ace110', '', 14999, 'macbook.png', '', 4.95, 5),
    ('007749b5-434c-4be8-8c91-8db273ace111', '', 14999, 'macbook.png', '', 4.90, 5),
    ('007749b5-434c-4be8-8c91-8db273ace112', '', 14999, 'macbook.png', '', 4.95, 5),
    ('007749b5-434c-4be8-8c91-8db273ace113', '', 14999, 'macbook.png', '', 4.90, 5),
    ('007749b5-434c-4be8-8c91-8db273ace114', '', 14999, 'macbook.png', '', 4.95, 5),
    ('007749b5-434c-4be8-8c91-8db273ace115', '', 14999, 'macbook.png', '', 4.90, 5),
    ('007749b5-434c-4be8-8c91-8db273ace116', '', 14999, 'macbook.png', '', 4.95, 5),
    ('007749b5-434c-4be8-8c91-8db273ace117', '', 14999, 'macbook.png', '', 4.90, 5),
    ('007749b5-434c-4be8-8c91-8db273ace118', '', 14999, 'macbook.png', '', 4.95, 5),
    ('007749b5-434c-4be8-8c91-8db273ace119', '', 14999, 'macbook.png', '', 4.90, 5),
    ('007749b5-434c-4be8-8c91-8db273ace120', '', 14999, 'macbook.png', '', 4.90, 5);
